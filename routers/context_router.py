...
@router.post("/context/auto-trigger")
async def auto_trigger_context(req: ContextRequest):
    """Auto-triggered context loading -- returns trigger_reason.

    Unlike /context, this endpoint auto-detects WHY context is being loaded
    (session_start, topic_shift, correction, manual) and returns it.
    """
    from services.triggers import detect_trigger_reason
    ...
    trigger_reason = detect_trigger_reason(req.query)
