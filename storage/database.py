"""Brain Memory v4.1 — storage layer with shared connections for concurrency."""
...
def init_db():
    ...
    try:
        ...
        for col, ct in [("embedding", "TEXT DEFAULT NULL"), ("is_identity_forming", "INTEGER DEFAULT 0")]:
            try:
