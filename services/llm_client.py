...
DEEPSEEK_KEY = os.environ.get("DEEPSEEK_API_KEY", "YOUR_API_KEY_HERE")
DEEPSEEK_BASE = "https://api.deepseek.com/v1"
DEEPSEEK_MODEL = "deepseek-chat"  # V3

GLM_KEY = os.environ.get("GLM_API_KEY", os.environ.get("ZHIPU_API_KEY", "YOUR_API_KEY_HERE"))
GLM_BASE = "https://open.bigmodel.cn/api/paas/v4"
GLM_MODEL = "glm-4-flash"  # cheap + fast

DASHSCOPE_KEY = os.environ.get("DASHSCOPE_API_KEY", "YOUR_API_KEY_HERE")
